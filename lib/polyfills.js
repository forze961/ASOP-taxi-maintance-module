...
export async function polyfill(locale: string = '') {
  ...
  if (Intl.PluralRules?.polyfilled) {
    ...
    switch (lang) {
      ...
      case 'fr':
        dataPolyfills.push(
          import(/* webpackChunkName: "intl-pluralrules" */ '@formatjs/intl-pluralrules/locale-data/fr'),
        );
        break;
    }
  }
  ...
  if (Intl.DateTimeFormat.polyfilled) {
    ...
    switch (locale) {
      ...
      case 'fr':
        dataPolyfills.push(
          import(/* webpackChunkName: "intl-datetimeformat" */ '@formatjs/intl-datetimeformat/locale-data/fr'),
        );
        break;
    }
  }
  ...
  if (Intl.RelativeTimeFormat.polyfilled) {
    switch (locale) {
      ...
      case 'fr':
        dataPolyfills.push(
          import(/* webpackChunkName: "intl-relativetimeformat" */ '@formatjs/intl-relativetimeformat/locale-data/fr'),
        );
        break;
    }
  }
